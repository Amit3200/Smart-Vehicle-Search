...
else
{
    ...
    $sql1="select * from requestsf where name='$k' order by rid desc limit 1";
    $val2=$db->query($sql1);
    while($row1 = mysqli_fetch_array($val2))
    {
       $dat=$row1['RequestedDate']; 
    }
        ...
        <div class="container">
            <form method="post">
                ...
                <div class="subdivision"><br>
                    ...
                    <br>
                    <?php $k1 = preg_replace('/(^[\"\']|[\"\']$)/', '', $io);?>
                    <?php $k2=$k1.".png"?>
                    <center><img src='images/<?php echo $k2?>' width="140px"></center>
                </div>
                </center>
            </form>
        </div>
